...
class _OptionsSheetState extends State<_OptionsSheet> {
  ...
  void _downloadLyrics() {
    if (widget.song.cleanedLyrics== null || widget.song.cleanedLyrics.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
            ...
            children: [
              ...
              Flexible(
                child: SingleChildScrollView(
                  child: Text(widget.song.cleanedLyrics?? 'Tidak ada lirik', style: const TextStyle(fontSize: 16, height: 1.8)),
                ),
              ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.song.cleanedLyrics.isNotEmpty && widget.song.cleanedLyrics.isNotEmpty) ...[
