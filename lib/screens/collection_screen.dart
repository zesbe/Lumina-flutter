    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _OptionTile(
            icon: widget.song.isPublic ? Icons.public : Icons.public_off,
            iconColor: widget.song.isPublic ? const Color(0xFF22C55E) : null,
            title: widget.song.isPublic ? '🔒 Jadikan Private' : '🌐 Jadikan Public',
            subtitle: widget.song.isPublic ? 'Semua orang bisa melihat' : 'Hanya kamu yang bisa melihat',
            onTap: () {
              music.togglePublic(widget.song.id);
              Navigator.pop(context);
            },
          ),
